      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        ...
        <header className="mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-lg font-semibold" style={{ color: 'var(--text-h)' }}>Sarvam Developer Portal</span>
          </div>

          {/* Tab nav */}
          <nav className="flex gap-1 p-1 rounded-xl w-fit" style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }} role="tablist">
